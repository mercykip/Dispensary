...
if(isset($_POST['Submit'])) {    
    echo $pat_name = $_POST['pat_name'];
    echo $pat_email = $_POST['pat_email'];
    echo $DOB = $_POST['dob'];
    echo $gender = $_POST['gender'];
 
        $patient = $crud->execute("INSERT INTO `patient` (pat_name,pat_email,dob,gender) VALUES ('$pat_name', '$pat_email','$DOB','$gender'");
                            ...
                            <form class="form-material form-horizontal" method="POST" action="">
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="pat_email" name="pat_email" class="form-control" placeholder="enter patient name"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="bdate">Date of Birth</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" id="bdate" name="dob" class="form-control mydatepicker" placeholder="enter your birth date"> </div>
                                </div>
                                <div class="form-group">
                             ...
                             <!--    <div class="form-group">
                               ...
                               <!--  <div class="form-group">
                                ...
                                <input type="submit"  name="Submit" class="btn btn-info waves-effect waves-light m-r-10" value="Submit">
                        ...
                        <div class="white-box">
                            ...
                            <form class="form-material form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="email" id="example-email" name="example-email" class="form-control" placeholder="enter your email"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12" for="example-phone">Phone</span>
                                    </label>
                                    <div class="col-md-12">
                                        <input type="text" id="example-phone" name="example-phone" class="form-control" placeholder="enter your phone" data-mask="(999) 999-9999"> </div>
                                </div>
                                <div class="form-group">
